    ...
    'en-us': {
        cluster: {
            auth:                    chapter(
                ...
                'Kamatera Credentials',
                'Next: Configure Cluster',
            ),
            region:                  field('Region', 'eu-de', 'Your region'),
            'aksk':                  field('Use AK/SK auth'),
            // ak/sk auth:
            accessKey:               field('Kamatera API Client ID'),
            secretKey:               field('Kamatera API Secret'),
            // cluster config
            cluster:                 chapter(
...
export default Ember.Component.extend(ClusterDriver, {
    ...
    onAuthFieldsChange:    observer(
        ...
        function () {
            ...
            let missing = !(get(this, 'config.accessKey') && get(this, 'config.secretKey'));
